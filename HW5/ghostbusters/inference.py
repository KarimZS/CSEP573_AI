    ...
    def elapseTime(self, gameState):
        ...
        for pos in self.allPositions:
            ...
            for newPos, newProb in newPosDist.items():
                newBelief[newPos] += self.beliefs[pos] * newProb
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            new[particle] += self.getObservationProb(observation, gameState.getPacmanPosition(), particle,
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        totalLegal = list(itertools.product(self.legalPositions, repeat=self.numGhosts))

        for i in range(self.numParticles):
            self.particles.append(totalLegal[i % len(totalLegal)])
